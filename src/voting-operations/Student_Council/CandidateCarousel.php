...
/*Function For Checking IF There IsAtleast One SOM Position In Database*/
function Make_Query_For_Som_Position($connect,$campus){
    $output = '';
    $resultPosition = Make_Query_For_Som_Student_Council_Position($connect,$campus);
    $resultCheckePosition = mysqli_num_rows($resultPosition);
    if($resultCheckePosition > 0){
...
/*Function For SOM Student Council*/
...
/*Function For Getting The SOM Student Council Position*/
function Make_Query_For_Som_Student_Council_Position($connect,$campus)
{
...
/*Function For SOM Student Council Making a Carousel*/
function Make_Slides_For_Som_Student_Council($connect,$campus,$college,$program,$year){
    $output = '';
    $resultPosition = Make_Query_For_Som_Student_Council_Position($connect,$campus);
    $resultCheckePosition = mysqli_num_rows($resultPosition);
    if($resultCheckePosition > 0){
