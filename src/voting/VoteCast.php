  ...
  <div class="container-fluid">
    <div class="row">
      <div class="text-center col-12 mt-5">
        <img src="../img/Voted.gif" width="50%"  height="50%">
        <h1 class="h1 text-success text-responsive"> Congratulations! </h1>
        <p class="display-4 text-success text-responsive">You've successfully casted your vote.</p>
